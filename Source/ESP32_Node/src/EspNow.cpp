...
/*
    Master:
        MAC address: E0:5A:1B:6C:58:D0 (board co module SIM)

    Slave:
        MAC address: F0:24:F9:EB:71:34 (slave 1)
*/
...
void slaveOnDataRecv(const uint8_t *mac_addr, const uint8_t *incomingDataRaw, int len) {
